...
namespace Lap03_2
{
    public partial class frmSoanVanBan : Form
    {
        ...
        // 2.5. Định dạng B/I/U cho vùng chọn
        ...
        //        {
        //            // Nếu văn bản đã đậm, xóa thuộc tính Bold
        //            style &= ~FontStyle.Bold;
        //        }
        //        else
        //        {
        //            // Nếu văn bản chưa đậm, thêm thuộc tính Bold
        //            style |= FontStyle.Bold;
        //        }
        ...
        //    }
        //}
        //Hàm xử lý chung: toggle FontStyle cho vùng chọn
        private void ToggleFontStyle(FontStyle styleToToggle)
        {
            if (rtbContent.SelectionFont != null)
            {
                ...
                // Nếu đã có style này thì bỏ, ngược lại thì thêm
        ...
        private void mni_Format_Font_Click(object sender, EventArgs e)
        {
            ...
            {
                //rtbContent.ForeColor = fdlFont.Color;
                //rtbContent.Font = fdlFont.Font;
        ...
        private void cmbFont_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // Dùng font hiện tại ở caret/selection làm base (nếu mixed thì fallback rtbContent.Font)
        ...
        private void cmbSize_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            float size = Convert.ToSingle(cmbSize.SelectedItem); // ToolStripComboBox -> object
